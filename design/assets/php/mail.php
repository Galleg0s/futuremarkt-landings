...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to = "futuremarktagent@gmail.com, futuremarktagent@gmail.com, futuremarktagent@gmail.com";
    $formData = "Информация о заказе:";
    $sendfrom   = "spacemirror.ru";
                              ...
                              <tbody>
                                 <tr>
                                    <td valign='middle' width='270' style='padding: 10px 0 10px 20px;' class='logo'>
                                       <div class='imgpop'>
                                          <a href='#'  style='text-decoration:none;'><p style='display:block; border:none; outline:none; text-decoration:none; color: #fff;font-size: 24px; font-weight: bold;'>Space Mirror</p>
                              ...
                              <tbody>
                                 <tr>
                                    <td width='270' valign='middle' style='font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;line-height: 24px; padding: 10px 0;' align='right' class='menu' st-content='menu'>
                                       <a href='//spacemirror.ru/' style='text-decoration: none; color: #ffffff;'>ГЛАВНАЯ</a>
                                       &nbsp;|&nbsp;
